...
EXERCISED_COMMANDS = {
    ...
    "astroquery_object": {"service", "target", "ra_deg", "dec_deg", "radius_arcmin",
                          "row_limit", "output_format", "dataset_name"},
    "astroquery_adql": {"service", "query", "output_format", "dataset_name"},
    ...
    "cern_open_data_download": {"project_id", "record_id", "file_index", "max_bytes",
                                "timeout_seconds"},
